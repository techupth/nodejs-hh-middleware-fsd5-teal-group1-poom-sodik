...
import Validation from "../middleware/assignmentValidation.js";
...
assignmentRouter.post("/", Validation, (req, res) => {
...
assignmentRouter.put("/:id", Validation, (req, res) => {
...
assignmentRouter.post("/:id/comments", Validation, (req, res) => {
  const assignmentId = +req.params.id;
